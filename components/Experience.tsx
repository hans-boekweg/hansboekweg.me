...
const experiences: ExperienceItem[] = [
  {
    ...
    achievements: [
      ...
      "Led team of 5 developers, implementing agile practices that improved velocity by 40%",
  ...
  },
  {
    ...
    location: "Remote",
    period: "2020 - 2022",
    description: "Core developer for a fast-growing fintech startup.",
    achievements: [
      "Developed payment processing system handling $5M+ monthly transactions",
      "Implemented CI/CD pipeline reducing release cycle from weeks to hours",
      "Created component library used across 3 product lines",
      "Mentored 3 junior developers, establishing code review practices",
    ],
  },
  {
    ...
    period: "2018 - 2020",
    description: "Built web applications for Fortune 500 clients.",
    achievements: [
